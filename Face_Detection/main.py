...
# main.py (or wherever process_gaze is defined)
    ...
    with map_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5) as face_mesh:
        ...
        while True:
            ...
            if current_face_id is None:
                ...
                face_status = "Initial face detected"
            elif current_face_id != initial_face_id:
                face_status = "Different face detected"
                # Here you can take actions like pausing the exam, alerting, etc.
                # For example, you could break the loop to stop the exam
                break
            else:
                face_status = "Same face detected"
